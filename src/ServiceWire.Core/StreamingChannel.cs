    ...
    public class StreamingChannel : Channel, IDvChannel
    {
            ...
            string username = null, string password = null)
        {
            if (!string.IsNullOrEmpty(username) && !string.IsNullOrEmpty(password))
            {
                ...
                if (!userFound)
                {
                    throw new UnauthorizedAccessException("authentication failed (01)");
                }
                ...
                if (!serverVerified)
                {
                    throw new UnauthorizedAccessException("authentication failed (02)");
                }
                ...
                {
                    throw new UnauthorizedAccessException("authentication failed (03)");
                }
